...
export class AboutComponent implements OnInit {
  ...
  public FeatureText = 'THE TREASURE OF THE COMPANY IS ITS PEOPLE';
  public AboutUs = 'What is TechPlans ?';
  ...
  public ManagerQuote = '“To live life within boundaries, to limit your existence by fearing the unexpected, to make choices based on needs and not wants, that is humanity’s biggest failure.”';
